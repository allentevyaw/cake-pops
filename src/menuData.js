...
export const menuData = {
    title: 'Menu',
    subtitle: 'Check out our tasty treats!',
    btnText: 'Order Now',
    menuItems: [
      {
        image: oreo,
      ...
      },
      {
        ...
        price: '$20/dozen',
        description: 'A powerful and decadent cake pop with a deep cocoa flavor, coated in chocolate and topped with prinkles, cocoa powder, or oreos',
      },
      {
        image: toast,
